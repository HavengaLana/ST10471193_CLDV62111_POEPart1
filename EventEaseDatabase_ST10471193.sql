USE master;
IF EXISTS (SELECT * FROM sys.databases WHERE name = 'EventEase_ST10471193')
DROP DATABASE EventEase_ST10471193;
CREATE DATABASE EventEase_ST10471193;

USE EventEase_ST10471193;
